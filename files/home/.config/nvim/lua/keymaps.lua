...
local keyboard = {
  ...
  mappings = {
    ...
    debug = { -- [[
      ...
      { {'n',      }, '<leader>ds',     maps.debug_terminate,    { desc = ' stop'                 } },
      { {'n',      }, '<leader>dt',     maps.debug_pause,        { desc = '󱇫 pause thread'         } },
      { {'n',      }, '<leader>dk',     maps.debug_step_into,    { desc = '󰆹 step into'            } },
      { {'n',      }, '<leader>dj',     maps.debug_step_out,     { desc = '󰆸 step out'             } },
      { {'n',      }, '<leader>dl',     maps.debug_step_over,    { desc = '󰆷 step over'            } },
      { {'n',      }, '<leader>dg',     maps.debug_continue,     { desc = ' continue'             } },
      { {'n',      }, '<leader>d!',     maps.debug_repl,         { desc = ' repl'                 } },
      { {'n',      }, '<leader>db',     maps.debug_bp_toggle,    { desc = ' breakpoint toggle'    } },
      { {'n',      }, '<leader>dc',     maps.debug_bp_condition, { desc = '󰊕 breakpoint condition' } },
      { {'n',      }, '<leader>dx',     maps.debug_bp_clear,     { desc = ' breakpoint clear'     } },
