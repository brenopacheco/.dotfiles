...
local keyboard = {
  ...
  mappings = {
    ...
    debug = { -- [[
      ...
      { {'n',      }, '<leader>dd',     maps.debug_restart,      { desc = ' restart'              } },
      { {'n',      }, '<leader>dr',     maps.debug_last,         { desc = ' run last'             } },
      { {'n',      }, '<leader>dr',     maps.debug_terminate,    { desc = ' stop'                 } },
      { {'n',      }, '<leader>dd',     maps.debug_pause,        { desc = '󱇫 pause thread'         } },
      { {'n',      }, '<leader>dd',     maps.debug_step_into,    { desc = '󰆹 step into'            } },
      { {'n',      }, '<leader>dd',     maps.debug_step_out,     { desc = '󰆸 step out'             } },
      { {'n',      }, '<leader>dd',     maps.debug_step_over,    { desc = '󰆷 step over'            } },
      { {'n',      }, '<leader>dd',     maps.debug_continue,     { desc = ' continue'             } },
      { {'n',      }, '<leader>dd',     maps.debug_repl,         { desc = ' repl'                 } },
      { {'n',      }, '<leader>dd',     maps.debug_bp_toggle,    { desc = ' breakpoint toggle'    } },
      { {'n',      }, '<leader>dd',     maps.debug_bp_condition, { desc = '󰊕 breakpoint condition' } },
      { {'n',      }, '<leader>dd',     maps.debug_bp_clear,     { desc = ' breakpoint clear'     } },
      { {'n',      }, '<leader>dd',     maps.debug_bp_list,      { desc = ' breakpoint list'      } },
      { {'n',      }, '<leader>dd',     maps.debug_hover,        { desc = '󱄑 info hover'           } },
      { {'n',      }, '<leader>dd',     maps.debug_preview,      { desc = '󰩣 info preview'         } },
    }, -- ]]
    find = { -- [[
