...
" 1. list does not update if operator pending (jk/kj)
" 2. pressing tab when completion is the same as what's written and is not 
"    a snippet should give a tab
" 3. completing without expanding should press a space after
" 4. completing function should materialize parens (works on c. works on vim
"    only if selecting manually. doesn't work on javascript)
" 5. menu is opening up without any character
